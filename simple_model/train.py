...
class Trainer(metaclass=ABCMeta):
    def __init__(self, device, model, loss_function,
                train_loader, val_loader, batch_size=10):    
        # import param
        self.device = device
...
def train_the_model(device, model_name,model, loss_function, train_loader, val_loader, hyper, epochs=200):
    # define parameters
    file_name=f"hyper_{str(hyper)}_model_name_{str(model_name)}"
    ...
    trainer = Trainer(device, model, loss_function, train_loader, val_loader, batch_size = 10)
